...
public class DefaultListableBeanFactory extends abstratBeanFactory
    ...
    public void RegisterBeanDefintionbyAnnotation() throws ClassNotFoundException {
        // TODO Auto-generated method stub
        List<String> list = this.getAutowiredlist();
            ...
            for (String string : list) {
                ...
                for (String string2 : list2) {
                    ...
                    if (forName.isAnnotationPresent(Component.class)) {
                        ...
                        this.getBeanNamesList().add(definition.getId());
                        this.getBeanDefinitionMap().put(forName.getSimpleName(), definition);
                        this.getBeanFactory().put(definition.getId(), definition.getBeanClass());
                    }
                }
            }
            System.out.println(this.getBeanDefinitionMap().toString());
        }
